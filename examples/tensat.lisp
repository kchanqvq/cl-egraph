...
(defvar *tensat-rules*
  '(EWADD-IS-ASSOCIATIVE EWADD-IS-COMMUNITATIVE EWMUL-IS-ASSOCIATIVE EWMUL-IS-COMMUNITATIVE DISTRIBUTIVE-0
    SMUL-IS-ASSOCIATIVE DISTRIBUTIVE-1 OPERATOR-COMMUTATIVITY-0 TRANSPOSE-IS-ITS-OWN-INVERSE
    OPERATOR-COMMUTATIVITY-1 OPERATOR-COMMUTATIVITY-2 OPERATOR-COMMUTATIVITY-3
    MATMUL-IS-ASSOCIATIVE MATMUL-IS-LINEAR-0 MATMUL-IS-LINEAR-1 MATMUL-AND-TRANSPOSE
    CONV-IS-BILINEAR-0 CONV-IS-BILINEAR-1 CONV-IS-BILINEAR-2 CONV-IS-BILINEAR-3
    -ENLARGE-CONVOLUTION-KERNEL OPERATOR-COMMUTATIVITY-4 CONV-WITH-2-APPLIES-RELU
    -POOLING-BY-CONV.-WITH-CPOOL CONST-ICONV-AND-CONST-POOL IDENTITY-KERNEL IDENTITY-MATRIX
    EWMUL-IDENTITY SPLIT-DEFINITION-0 SPLIT-DEFINITION-1 GEOMETRY-OF-CONCATENATION
    OPERATOR-COMMUTATIVITY-5 OPERATOR-COMMUTATIVITY-6 OPERATOR-COMMUTATIVITY-7
    OPERATOR-COMMUTATIVITY-8 CONCATENATION-AND-TRANSPOSE CONCATENATION-AND-MATRIX-MUL.-0
    CONCATENATION-AND-MATRIX-MUL.-1 CONCATENATION-AND-CONV.-0 CONCATENATION-AND-CONV.-1
    CONCATENATION-AND-CONV.-2 CONCATENATION-AND-POOLING-0 CONCATENATION-AND-POOLING-1
    CONCATENATION-AND-POOLING-2))
